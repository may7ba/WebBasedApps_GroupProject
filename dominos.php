...
<img src="pizza.jpg" height="100px" width="200px" style="margin-left:400px;padding-bottom:15px" /><br>
<iframe width="450" height="300" src="https://www.youtube.com/embed/_FNKVZTi9Hk" frameborder="0"  style="margin-left:40px;margin-right:20px;border: 2px solid red"allowfullscreen></iframe>
<iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d387116.80603797024!2d-112.10347945434123!3d40.710309980044045!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sdominos!5e0!3m2!1sen!2sus!4v1449595068385" width="450" height="300" frameborder="0" style="border: 2px solid yellow" allowfullscreen></iframe> 
<p>
<a href="https://www.dominos.com/en/?route=1"><h2 style="text-align:center;margin-left:30px;background-color:white;color:blue">DOMINO'S WEBSITE</h1></a>
...
$query="SELECT offer ,vendor_id from offers where vendor_id='2' ;";
...
on customer.customer_id=review.customer_id where review.vendor_id='2' ;";
$result=$conn->query($query);
if(!$result) die ($conn->error);
